# 66.71% accuracy with 0.8086 loss, but takes 11th epoch for rapid decrease in loss
...
from keras.layers import Embedding, Dense, Dropout, LSTM, Bidirectional, CuDNNLSTM
