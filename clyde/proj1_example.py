...
from keras.layers import Input, Reshape, Embedding, Dense, Dropout, Bidirectional, CuDNNLSTM, Conv2D, MaxPool2D, Flatten, Concatenate, BatchNormalization
...
if __name__ == '__main__':
    ...
    for size in kernel_sizes:
        conv = Conv2D(filters=filters, kernel_size=(size, embedding_size), padding='valid', activation='relu')(e_d)
    ...
    # c_d = Dropout(dropout_hidden)(c)  # can remove or change to batch normalization
    c_d = BatchNormalization()(c)
