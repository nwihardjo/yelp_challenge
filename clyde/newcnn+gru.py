...
from keras.layers import Input, Reshape, Embedding, Dense, Dropout, Bidirectional, CuDNNGRU, Conv2D, MaxPool2D, Flatten, Concatenate, BatchNormalization, Activation
...
if __name__ == '__main__':
    ...
    for size in kernel_sizes:
        ...
        max_pool = MaxPool2D(pool_size=((input_length-size)//5, 1))(conv)
    ...
    c_d = Reshape((filters*len(conv_blocks)*5, 1))(c)

    # Dense layer
    # d = Dense(hidden_size, activation='relu')(c)
    # d_d = Dropout(dropout_hidden)(d)

    # LSTM layer
    lstm = Bidirectional(CuDNNGRU(units=hidden_size))(c_d)
