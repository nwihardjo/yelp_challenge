# tried .5/.6 dropout to reach 66 percent 0.82 loss but resets sometimes
# .3/.5 dropout reaches 65.6 percent with .8320 loss, no more resets
...
from keras.layers import Embedding, Dense, Dropout, LSTM, Bidirectional, CuDNNLSTM, CuDNNGRU, Conv1D, MaxPool1D, BatchNormalization
...
if __name__ == '__main__':
    ...
    # LSTM layer
    # YOUR CODE HERE
    model.add(Bidirectional(CuDNNGRU(units=hidden_size)))
