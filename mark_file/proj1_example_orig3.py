...
from keras.layers import Embedding, Dense, Dropout, CuDNNLSTM, Bidirectional, Reshape
...
if __name__ == '__main__':
    ...
    model.add(Bidirectional(CuDNNLSTM(units=hidden_size, return_state=True), merge_mode='concat'))
    model.add(Input())
    model.add(Reshape(hidden_size, -1))
